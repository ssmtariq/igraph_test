...
igraph_error_t memory_map_order(const char *order_filename, igraph_integer_t no_of_elements, igraph_vector_int_t *order) {
    int fd;
...
igraph_error_t igraph_bfs(const igraph_t *graph,
    ...
    is_map_success = memory_map_order("/tmp/order_map.bin", no_of_nodes, order);
